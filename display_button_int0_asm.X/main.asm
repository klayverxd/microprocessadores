...
INT_HIGH_VECT CODE    0X0008
    GOTO INT_IRQ  ; Desvia para rotina de interrupção de alta prioridade
...
;*******************************************************************************
    ...
    BSF INTCON, GIE	; HABILITA TODAS INTERRUPÇOES (chave geral das interrupções)
    BSF INTCON, PEIE	; HABILITA INTERRUPÇOES PARA TODOS PERIFERICOS
...
CONTA
    MOVLW .9
    INCF DISP1
    CPFSGT DISP1 ; COMPARA SE DISP1 MAIOR QUE W (9)
    RETURN
    CLRF DISP1
    INCF DISP2
    CPFSGT DISP2 ; COMPARA SE DISP2 MAIOR QUE W (9)
    RETURN
    CLRF DISP2
    RETURN
...
ATUALIZA_PORTD     ; Para mostrar numero em decimal com valores em hexa
    SWAPF DISP2,W  ; inverte bits mais significativos com menos significativos
    IORWF DISP1,W  ; soma os bits de DISP1 com DISP2
    MOVWF PORTD
    RETURN
